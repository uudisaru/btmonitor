...
#>
function lint() {
    poetry run flake8 src\btmonitor tests
}
...
#>
function docs(){
    if (Test-Path ".\docs\btmonitor.rst") { Remove-Item ".\docs\btmonitor.rst" -Force }
    if (Test-Path ".\docs\modules.rst") { Remove-Item ".\docs\modules.rst" -Force }
    poetry run sphinx-apidoc -o docs\ src\btmonitor
